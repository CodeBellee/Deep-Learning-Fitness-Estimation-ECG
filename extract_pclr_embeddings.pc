...
BASE_DIR = "/PATH/TO/YOUR/PROJECT/DATA"

ECG_PATH    = os.path.join(BASE_DIR, "preprocessed_ep_rECG_i2")
MODEL_PATH  = os.path.join(BASE_DIR, "PCLR.h5")
OUTPUT_FILE = os.path.join(BASE_DIR, "pclr_emb_i2.csv")
