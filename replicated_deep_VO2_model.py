...
ECG_PATH    = os.path.join(BASE_DIR, "data/preprocessed_ep_VO2_i1_rECG_i2")
LABELS_FILE = os.path.join(BASE_DIR, "data/labels/real_ukbb_values/30038-1.0.csv")
AGE2_SEX_BMI2_PATH = os.path.join(BASE_DIR,"data/eid_age2_sex_bmi2.csv")
MODEL_PATH  = os.path.join(BASE_DIR, "data/PCLR.h5")
