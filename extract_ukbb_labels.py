...
PROJECTS_ROOT = "/PATH/TO/YOUR/DATA/PROJECTS"
INPUT_FILE_PATH = os.path.join(PROJECTS_ROOT, "PROJECT/FOLDER/DATAFILE.csv")
OUTPUT_DIR = os.path.join(PROJECTS_ROOT, "YOUR/BASE/DIR/data/labels/real_ukbb_values/")
