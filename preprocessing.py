...
EIDS_PATH  = os.path.join(BASE_DATA_DIR, "data/labels/manifest_ecg_rest.csv")
ECG_PATH   = os.path.join(BASE_DATA_DIR, "ukbb/raw/Bulk/ECG")
OUT_FOLDER = os.path.join(BASE_DATA_DIR, "data/preprocessed_ep_rECG_i2")
