...
TABULAR_INPUT_FILE_PATH = os.path.join(BASE_DIR, "DATAFILE.csv")
AGE_INPUT_FILE_PATH = os.path.join(BASE_DIR, "ukbb/processed/age_cohorts.csv")
RESTING_ECG_PATH = os.path.join(BASE_DIR, "ukbb/raw/Bulk/ECG")
