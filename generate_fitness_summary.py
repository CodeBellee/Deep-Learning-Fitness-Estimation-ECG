...
FITNESS_TASKS = {
    'VO2max_i1': {'id': '30038-1.0', 'path': os.path.join(LABELS_BASE_DIR, "labels_VO2max_instance_1.csv")},
    'VO2max_i0': {'id': '30038-0.0', 'path': os.path.join(LABELS_BASE_DIR, "labels_VO2max_instance_0.csv")},
    'Walking_Pace': {'id': '924-2.0', 'path': os.path.join(LABELS_BASE_DIR, "walking_pace_i2.csv")},
    'Able_To_Walk_10Min': {'id': '6017-1.0', 'path': os.path.join(LABELS_BASE_DIR, "6017-1.0_ABLE_TO_WALK_10MIN.csv")},
    'LVEF': {'id': '31060-2.0', 'path': os.path.join(LABELS_BASE_DIR, "31060-2.0_LVEF.csv")},
    'Systolic_BP': {'id': 'SYSTOLIC_BP_mean', 'path': os.path.join(LABELS_BASE_DIR, "SYSTOLIC_BP_2_mean.csv")},
    'Diastolic_BP': {'id': 'DIASTOLIC_BP_mean', 'path': os.path.join(LABELS_BASE_DIR, "DIASTOLIC_BP_2_mean.csv")},
    'Grip_Strength_Left': {'id': '46-2.0', 'path': os.path.join(LABELS_BASE_DIR, "grip_left_i2.csv")},
    'Grip_Strength_Right': {'id': '47-2.0', 'path': os.path.join(LABELS_BASE_DIR, "grip_right_i2.csv")},
    'Heel_Bone_T_Score': {'id': '78-0.0', 'path': os.path.join(LABELS_BASE_DIR, "78-0.0_HBM_T_SCORE.csv")},
    'Heel_Bone_Density_Left': {'id': '4106-2.0', 'path': os.path.join(LABELS_BASE_DIR, "4106-2.0_HBM_T_AUTO_LEFT.csv")},
    'Body_Fat_Percentage': {'id': '23099-2.0', 'path': os.path.join(LABELS_BASE_DIR, "23099-2.0_BODY_FAT_PERCENTAGE.csv")},
    'Whole_Body_Fat_Mass': {'id': '23100-2.0', 'path': os.path.join(LABELS_BASE_DIR, "23100-2.0_WHOLE_BODY_FAT_MASS.csv")},
    'Trunk_Fat_Percentage': {'id': '23127-2.0', 'path': os.path.join(LABELS_BASE_DIR, "23127-2.0_TRUNK_FAT_PERCENTAGE.csv")},
    'Trunk_Fat_Mass': {'id': '23128-2.0', 'path': os.path.join(LABELS_BASE_DIR, "23128-2.0_TRUNK_FAT_MASS.csv")},
    'FEV1_best_i0': {'id': '20150-0.0', 'path': os.path.join(LABELS_BASE_DIR, "FEV1_i0.csv")},
    'FEV1_i2': {'id': '3063-2.0', 'path': os.path.join(LABELS_BASE_DIR, "3063-2.0_FEV1.csv")},
    'Forced_Vital_Capacity': {'id': '3062-2.0', 'path': os.path.join(LABELS_BASE_DIR, "3062-2.0_FORCED_VITAL_CAPACITY.csv")},
    'FEV1_Predicted': {'id': '20153-0.0', 'path': os.path.join(LABELS_BASE_DIR, "20153-0.0_FEV1_PREDICTED.csv")},
    'FEV1_Predicted_Percentage': {'id': '20154-0.0', 'path': os.path.join(LABELS_BASE_DIR, "20154-0.0_FEV1_PREDICTED_PERCENTAGE.csv")},
    'FEV1_Z_Score': {'id': '20256-0.0', 'path': os.path.join(LABELS_BASE_DIR, "20256-0.0_FEV1_Z_SCORE.csv")},
    'FEV1_FVC_Ratio_Z': {'id': '20258-0.0', 'path': os.path.join(LABELS_BASE_DIR, "20258-0.0_FEV1_FVC_RATIO_Z_SCORE.csv")},
    'Tiredness_Freq': {'id': '2080-2.0', 'path': os.path.join(LABELS_BASE_DIR, "2080-2.0_FREQUENCY_OF_TIREDNESS.csv")},
    'Reaction_Time': {'id': '20023-2.0', 'path': os.path.join(LABELS_BASE_DIR, "20023-2.0_REACTION_TIME.csv")},
    'Health_Scale_Today': {'id': '120103-0.0', 'path': os.path.join(LABELS_BASE_DIR, "120103-0.0_SCALE_TO_INDICATE_HOW_HEALTH_IS_TODAY.csv")},
    'Health_Score_England': {'id': '26413-0.0', 'path': os.path.join(LABELS_BASE_DIR, "26413-0.0_HEALTH_SCORE_ENGLAND.csv")},
    'Health_Score_Scotland': {'id': '26420-0.0', 'path': os.path.join(LABELS_BASE_DIR, "26420-0.0_HEALTH_SCORE_SCOTLAND.csv")},
    'Health_Score_Wales': {'id': '26430-0.0', 'path': os.path.join(LABELS_BASE_DIR, "26430-0.0_HEALTH_SCORE_WALES.csv")}
}
