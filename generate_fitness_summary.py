...
LABELS_BASE_DIR = os.path.join(BASE_DATA_DIR, "labels/real_ukbb_values/")
RESTING_ECG_PATH = os.path.join(BASE_DATA_DIR, "ukbb/raw/Bulk/ECG")
OUTPUT_DIR = os.path.join(BASE_DATA_DIR, "analysis_dec_summarised/")
