...
MAIN_FILE_PATH = os.path.join(BASE_DATA_DIR, "ukbb/raw/Main/ukb_main_data.csv")
AGE_FILE_PATH = os.path.join(BASE_DATA_DIR, "ukbb/processed/age_cohorts.csv")
OUTPUT_FILE_NAME = os.path.join(BASE_DATA_DIR, "data/eid_age2_sex_bmi2.csv")
